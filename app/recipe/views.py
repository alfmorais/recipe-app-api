...
from drf_spectacular.utils import OpenApiParameter  # noqa
from drf_spectacular.utils import OpenApiTypes  # noqa
from drf_spectacular.utils import extend_schema  # noqa
from drf_spectacular.utils import extend_schema_view  # noqa
from recipe.serializers import IngredientSerializer  # noqa
from recipe.serializers import RecipeDetailSerializer  # noqa
from recipe.serializers import RecipeImageSerializer  # noqa
    ...
    list=extend_schema(
        parameters=[
            ...
            OpenApiParameter(
                "ingredients",
                OpenApiTypes.STR,
                description="Comma separated list of ingredients IDs to filter",  # noqa E501
            ),
        ],
    ),
)
